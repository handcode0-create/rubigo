...
export function ExploreIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function FavoritesIcon({ size = 20, filled = false, ...props }: IconProps & { filled?: boolean }) {
  return (
...
export function StarIcon({ size = 16, filled = true, ...props }: IconProps & { filled?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={filled ? "#F5A623" : "none"} stroke="#F5A623" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function MotoIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <circle cx="5.5" cy="17.5" r="3.5" />
      <circle cx="18.5" cy="17.5" r="3.5" />
      <path d="M15 6h-3l-3 6.5h8.5l2-4.5H15z" />
      <path d="M12 17.5h-3l-2-5" />
      <path d="M19 9l2-3h-4" />
    </svg>
  )
}
...
export function ForkKnifeIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M18 2v20M2 2v8a4 4 0 0 0 4 4h0a4 4 0 0 0 4-4V2M6 2v18" />
    </svg>
  )
}

export function DrinkIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M17 3H7l1 10a4 4 0 0 0 4 3.82V21m-3 0h6" />
      <line x1="5" y1="3" x2="19" y2="3" />
    </svg>
  )
}

export function ChickenIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M14 4a6 6 0 0 0-6 6c0 2.5 1 4 2.5 5.5l-4.5 4.5h6l2-2" />
...
export function FishIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M2 16s5-1 9-5 9-5 11-5c-2 2-2 7-6 11s-9 5-14-1z" />
      <path d="M18 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />
      <path d="M2 16l3 5M2 16l5-3" />
    </svg>
  )
}
