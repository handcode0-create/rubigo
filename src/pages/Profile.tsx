...
export function Profile({ onNavigate }: { onNavigate: (page: Page) => void }) {
  const { user, addAddress, removeAddress, setDefaultAddress, logout } = useApp()
